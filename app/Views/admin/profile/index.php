...
<form action="<?= base_url('admin/profile/update') ?>" method="post" class="space-y-5">
    ...
    <section class="bg-white border border-slate-200 rounded-xl shadow-sm dark:bg-slate-900 dark:border-slate-800 min-w-0 max-w-full">
        <div class="p-4 sm:p-5 min-w-0 space-y-5">
            <h2 class="text-base font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                <i data-lucide="user-round" class="size-5 text-blue-600 dark:text-blue-400"></i>
                Informasi Profil
            </h2>
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="name" name="name" class="py-2.5 px-3.5 block w-full border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-200"
    ...
    <section class="bg-white border border-slate-200 rounded-xl shadow-sm dark:bg-slate-900 dark:border-slate-800 min-w-0 max-w-full">
        <div class="p-4 sm:p-5 min-w-0 space-y-5">
            <div class="flex items-center gap-2">
                <h2 class="text-base font-bold text-slate-800 dark:text-slate-200 flex items-center gap-2">
                    <i data-lucide="shield-check" class="size-5 text-blue-600 dark:text-blue-400"></i>
                    Keamanan Akun
                </h2>
            ...
            <div>
                ...
                <input type="password" id="current_password" name="current_password" class="py-2.5 px-3.5 block w-full border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-200"
            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div>
                    ...
                    <input type="password" id="new_password" name="new_password" class="py-2.5 px-3.5 block w-full border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-200"
                ...
                <div>
                    ...
                    <input type="password" id="new_password_confirmation" name="new_password_confirmation" class="py-2.5 px-3.5 block w-full border border-slate-200 rounded-xl text-sm placeholder:text-slate-400 focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-slate-700 dark:text-slate-200"
                        autocomplete="new-password" minlength="8" maxlength="72"
    ...
    <div class="mt-6 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
        ...
        <button type="submit" class="py-2.5 px-4 inline-flex items-center justify-center gap-x-2 text-sm font-semibold rounded-xl border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 w-full sm:w-auto shadow-xs">
